      ...
      <Sidebar isSidebar={isSidebar} />
          ...
          <main className="content">
            ...
            <Routes>
              ...
              <Route path="/dashboard/:schoolname/:datevisit" element={<Dashboard />} />
              <Route path="/information/:schoolname/:datevisit" element={<Information />} />
              <Route path="/details" element={<Team />} />
